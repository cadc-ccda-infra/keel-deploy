...
| `ac-ldap-config` | LDAP proxy password (`proxyPassword`) used to generate `ac-ldap-config.properties` | `ac/base.yaml` (`application.ldap.proxyPassword.existingSecret`) |
